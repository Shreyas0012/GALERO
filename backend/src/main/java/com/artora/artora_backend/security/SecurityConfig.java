package com.artora.artora_backend.security;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.PUT, "/api/artworks/**", "/api/artists/**").hasAnyRole("ADMIN", "ARTIST")
                .requestMatchers(HttpMethod.DELETE, "/api/artworks/**", "/api/artists/**").hasRole("ADMIN")
